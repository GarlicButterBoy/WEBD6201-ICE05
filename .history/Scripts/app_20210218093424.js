...
*/
    ...
    $("#loginButton").on("click", function() 
    {
      ...
      $.get("./Data/users.json", function(data)
      {
       // console.log(data.users, function() {
          ...
          {
            //if both the username and password exist in users.json
          ...
          //if username and password matches and login is successful
          if (success)
          {
  ...
  function toggleLogin()
  {
    ...
    if(sessionStorage.getItem("user"))
    {
      ...
      $("#login").insertBefore(
        `<li class="nav-item">
         <a class="nav-link" aria-current="page" href="contact-list.html"><i class="fas fa-phone fa-lg"></i> Contact List</a>
         </li>`
      );
    }
  }
